...
class SemiOfficer extends Model
{
    use HasFactory;
    protected $fillable = [
        'militray_id',
    ...
    public function getImageAttribute($value)
    {
        ...
        return ($value == null ? '' : $actual_link . 'images/semi_officers/' . $value);
    }

    public function getIdImageAttribute($value)
    {
        $actual_link = (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . '/';
        return ($value == null ? '' : $actual_link . 'images/semi_officers_id_images/' . $value);
    }
