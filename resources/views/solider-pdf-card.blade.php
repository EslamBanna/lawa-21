...
<body>
    <div id="officer-card">
        ...
        <div id="officer-data">
            <h3 style="text-decoration: underline">كارت بيانات جندي</h3>
            <table>
                <tr>
                    <td><span> تاريخ التسريح: {{ $officer->left_in }}</span> </td>
                    ...
                    <td><span>الدرجة: {{ $officer->degree }}</span></td>
                    <td><span>الرقم العسكري: {{ $officer->militray_id }}</span></td>
                </tr>
                <tr>
                    <td><span>المؤهل: {{ $officer->certification }}</span> </td>
                    <td><span>التخصص بالوحدة: {{ $officer->specialist }}</span></td>
                ...
                <tr style="text-align: center">
                    ...
                    <td><span>الصورة الشخصية: </span>
                        ...
                        @if ($officer->image != null)
                            <img src="{{ public_path() . '/images/officers/' . $officer_image }}" width="200"
                                height="120" />
                        @endif
                    </td>
                    <td><span>صورة البطاقة: </span>
                        ...
                        @if ($officer->id_image != null)
                            <img src="{{ public_path() . '/images/officers_id_images/' . $id_image }}" width="200"
                                height="120" />
                        @endif
                    </td>
                    ...
                    <td><span>صورة الكارنية: </span>
                        ...
                        @if ($officer->militray_image != null)
                            <img src="{{ public_path() . '/images/officers_militray_images/' . $militray_image }}"
